  ...
  <li>
    <details>
      <summary markdown="span">Install node.js</summary>
        <p>If you haven't already, start by installing node.js using your favorite<a href='https://nodejs.org/en/download/package-manager'>package manager</a> or use the node.js<a href='https://nodejs.org/en/download'>installer</a> for your operating system.</p>
    </details>
  </li>
  <li>
    <details>
