...
function mastercardMfaChoice_injector($inject) {
  const { appConfig, BaseInputElement, sleep, document, window, logger } =
    $inject;
  ...
  return class MastercardInput extends BaseInputElement {
    ...
    generateInputStyleObject() {
      ...
      mockElement.classList.add('mastercard-mfa-text-input');
    ...
    generateRadioStyleObject() {
      const mockElement = document.createElement('input');
      mockElement.classList.add('mastercard-mfa-radio-input');
    ...
    generateImageStyleObject() {
      ...
      mockElement.classList.add('mastercard-mfa-image');
      return this.generateBaseStyle(mockElement);
    }
    ...
    generateLabelStyleObject() {
      ...
      mockElement.classList.add('mastercard-mfa-label');
      return this.generateBaseStyle(mockElement);
    }
  };
}
